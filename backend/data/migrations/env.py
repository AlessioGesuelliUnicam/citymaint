...
# Import tutti i modelli per far sì che Alembic li rilevi
...
from app.models.segnalazione_intervento import SegnalazioneIntervento
...
def do_run_migrations(connection: Connection) -> None:
    context.configure(
        ...
        include_object=lambda obj, name, type_, reflected, compare_to: (
            True if not reflected else False
        ),
    )
    with context.begin_transaction():
        context.run_migrations()
